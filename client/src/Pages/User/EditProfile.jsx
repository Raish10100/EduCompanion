...
//   console.log(userName)
  ...
  const handleFormSubmit = async (event) => {
    if (profileUpdated) {
      ...
      if(email == 'guest@edu-companion.online'){
           console.log(email)
          toast.error("You are not authorized to update the profile as this is a guest account.");
          return;
        }
      ...
      if (
        ...
        (data.fullName.length < 5 || data.fullName.length > 25)
      ) {
        ...
        >
          ...
          <div className="flex vs:flex-row flex-col items-center vs:items-start justify-between w-[90%] gap-3  vs:gap-0">
            {!previewImage ? (
              ...
              <img
                src={previewImage}
                className="rounded-full w-[100px] h-[100px] text-black"
              />
            )}
          ...
          <div className="fields w-[90%] flex flex-col justify-center items-center mt-8 gap-6">
            <div className="w-[100%] flex flex-col gap-1">
              <label
                htmlFor="Name"
                className="text-start w-[100%] text-xl font-bold dark:text-white text-black"
              >
                Name
              </label>
              <input
            ...
            >
              <AiOutlineArrowLeft className="" size={20} />{" "}

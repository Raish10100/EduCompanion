        ...
        <>
            <HomeLayout >
                    <div className="homePage h-[600px] sm:h-[800px] flex   px-[20px]">
                        <div className="w-[95%] lg:w-[60%] flex sm:mt-[200px] mt-[50px] vs:mt-[100px] flex-col gap-6 ">
                            <h1 className='text-3xl sm:text-5xl font-semibold text-white'>
                                Empower Your Learning Journey with Our <span className='text-[#3c8ff4]'>Comprehensive Courses</span>
                            </h1>
                            ...
                            <div className="flex flex-row  flex-wrap gap-8 sm:gap-2 mt-12 ">
                                ...
                                <button><Link className="border-2  border-gray-500 shadow-2xl hover:border-gray-200 transition-all ease-in-out duration-300 text-white sm:px-20 px-6 py-2 sm:py-4 rounded-sm text-2xl">Contact Us</Link></button>
                            </div>
                        </div>
                    </div>
            </HomeLayout>

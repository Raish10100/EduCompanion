...
function HomePage() {
    ...
    return (
            ...
            <HomeLayout >
                    <div className="homePage h-[550px] vs:h-[600px] sm:h-[800px] flex  gap-[100px] px-[10px] vs:px-[20px] ">
                        <div className="w-[95%] lg:w-[60%] flex justify-center items-center flex-col gap-6 ">
                            ...
                            <div className="flex flex-row flex-wrap vs:h-[150px] justify-start w-[100%] gap-8 sm:gap-2 mt-6 vs:mt-12 ">

...
function SignUp() {
  ...
  return (
    <HomeLayout>
      <div className="flex justify-center items-center  py-5 vs:py-10 dark:bg-[#12213b] bg-[#e5e7eb] lg:h-[90vh] ">
        <form
        ...
        >
          ...
          <div className="fields w-[90%] flex flex-col justify-center items-center gap-4">
            <div className="w-[100%] flex flex-col gap-1">
              <label
                htmlFor="Name"
                className="text-start w-[100%] text-sm sm:text-xl  font-bold dark:text-white text-black"
              >
                Name
              </label>
              <input
                ...
                className="lowercase-input px-3 py-3 w-[100%] outline-none dark:hover:border-[#fff] border-black transition-all ease-in-out duration-300 tracking-widest text-black  dark:text-white dark:border-[#ffffff91] text-sm sm:text-xl  border-2 rounded bg-transparent placeholder:text-black placeholder:dark:text-white placeholder:normal-case"
            ...
            <div className="w-[100%] flex flex-col gap-1">
              ...
              <div className=" vs:w-[100%] w-[100%]  text-wrap custom-group-avatar relative">
                <input
                  ...
                  accept=".jpg, .jpeg, .png"
                />
                <button className=" flex justify-between flex-wrap px-3 py-3 w-[100%]   tracking-widest border-black   dark:border-[#ffffff91] border-2 text-sm sm:text-xl rounded bg-transparent cursor-pointer">
                  ...
                  <span className="dark:text-[#5f6cf6]  text-[#e45f5f] font-bold">
                    {fileName ? "" : "(Optional)"}
                  </span>
                </button>
              </div>

  ...
  return (
    <footer className=" dark:bg-[#12213b] border-t-2 bg-gray-200 border-gray-500 py-7 z-0">
        ...
        <section className="flex flex-col gap-6 justify-center items-center sm:items-start">
          ...
          <p>
            <a
              ...
              class="hover:text-[#3c8ff4] underline text-blue-600 transition-all duration-300 ease-in-out"
            >
              +91 9426316486
            </a>
          </p>{" "}
      ...
      <section className="copyright text-lg text-[#000] dark:text-white text-center mt-16">
        ...
        <a
          className="hover:text-[#3c8ff4] underline font-bold text-blue-600 hover:underline transition-all duration-300 ease-in-out"
          href="https://www.linkedin.com/in/raish-vadaviya-439213289/"
          target="_blank"
        >
          {" "}
